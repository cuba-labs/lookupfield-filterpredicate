package com.company.lookupfieldfilterpredicate;
...
public class LookupfieldfilterpredicateTestContainer extends TestContainer {

    public LookupfieldfilterpredicateTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/lookupfieldfilterpredicate/app.properties",
    ...
    public static class Common extends LookupfieldfilterpredicateTestContainer {

        public static final LookupfieldfilterpredicateTestContainer.Common INSTANCE = new LookupfieldfilterpredicateTestContainer.Common();
